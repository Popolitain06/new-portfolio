...
const NegativeCursorEffect = () => {
  useEffect(() => {
    ...
    const techElements = document.querySelectorAll('.tech-cursor-target');
    ...
    avatarElement.addEventListener('mouseenter', enlargeCursor);
    avatarElement.addEventListener('mouseleave', resetCursor);
